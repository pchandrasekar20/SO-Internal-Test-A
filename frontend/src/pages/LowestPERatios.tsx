...
import { useLowestPEStocks } from '@/hooks/useStocks'
import { Table, Column } from '@/components/Table'
import { Pagination } from '@/components/Pagination'
import { SearchFilter, FilterState } from '@/components/SearchFilter'
import { LastUpdated } from '@/components/LastUpdated'
import { StockWithPERatio, QueryParams } from '@/api/types'

export const LowestPERatios: React.FC = () => {
  ...
  const columns: Column<StockWithPERatio>[] = [
    {
      key: 'symbol',
      label: 'Symbol',
      sortable: true,
    ...
    <div className="flex flex-col">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Stocks with the lowest price-to-earnings ratios. Lower P/E ratios may
          indicate undervalued stocks.
        </p>
      </div>
