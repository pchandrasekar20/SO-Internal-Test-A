...
function App() {
    var _a = useState('lowest-pe'), activeTab = _a[0], setActiveTab = _a[1];
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex space-x-8" aria-label="Main navigation">
            <button onClick={function () { return setActiveTab('lowest-pe'); }} className={"py-4 px-1 border-b-2 font-medium text-sm transition-colors ".concat(activeTab === 'lowest-pe'
            ? 'border-blue-600 text-blue-600'
            : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300')} aria-current={activeTab === 'lowest-pe' ? 'page' : undefined}>
              💎 Lowest P/E Ratios
            </button>
            <button onClick={function () { return setActiveTab('largest-declines'); }} className={"py-4 px-1 border-b-2 font-medium text-sm transition-colors ".concat(activeTab === 'largest-declines'
            ? 'border-blue-600 text-blue-600'
            : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300')} aria-current={activeTab === 'largest-declines' ? 'page' : undefined}>
